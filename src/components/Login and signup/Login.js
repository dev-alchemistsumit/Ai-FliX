      ...
      <div className="flex flex-col md:flex-col  ">
        <div className="flex flex-row justify-between fixed m-5 md:m-0 md:static  bg-mynavyblue header-container">
          ...
          <div className="flex flex-col justify-center p-3 m-3 rounded-full bg-white text-black ">
            <button onClick={handleLogin} className="text-md">Log in with Google</button>
          </div>
        </div>
        ...
        <div className="flex md:w-1/5   "></div>
          <div className=" flex flex-col mt-32 w-full md:flex-col  justify-center md:w-1/5 ">
            <div className=" flex  flex-col justify-center ">
              <div className=""> 
              <p className="text-3xl p-3 m-3 text-center font-serif ">Ai-FliX </p>
              ...
              <div class="flex md:flex  m-5 p-3 rounded-md overflow-hidden md:w-full shadow-lg shadow-indigo-700/100 ">
                <input type="text" class="w-full text-indigo-700 font-serif font-bold rounded-md text-center rounded-r-none" placeholder="Subscribe for Newsletters" />
...
<div className="w-1/5"></div>
      ...
      <img src={one} className="w-64 h-64 p-2 m-2  md:p-8  hover:border-2  rounded-2xl hover:border-white "/>
      <img src={two} className="w-64 h-64 p-2 m-2 md:p-8  hover:border-2  rounded-2xl hover:border-white"/>
      <img src={three} className="w-64 h-64 p-2 m-2 md:p-8  hover:border-2  rounded-2xl hover:border-white"/>
      
      <img src={four} className="w-64 h-64 p-2 m-2 md:p-8  hover:border-2  rounded-2xl hover:border-white"/>
      <img src={five} className="w-64 h-64 p-2 m-2 md:p-8  hover:border-2  rounded-2xl hover:border-white"/>
      <img src={six} className="w-64 h-64 p-2 m-2 md:p-8  hover:border-2  rounded-2xl hover:border-white"/>
      
      <img src={seven} className="w-64 h-64 p-2 m-2 md:p-8  hover:border-2  rounded-2xl hover:border-white"/>
      <img src={seven} className="w-64 h-64 p-2 m-2 md:p-8  hover:border-2  rounded-2xl hover:border-white"/>
      <img src={seven} className="w-64 h-64 p-2 m-2 md:p-8  hover:border-2  rounded-2xl hover:border-white"/>
